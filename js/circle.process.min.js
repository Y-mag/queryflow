	...
	b.fn = b.prototype = {
		...
		run: function() {
			...
			if (d.endSmallCircle.show) {
				this._smallCircle(d.endSmallCircle.radius, "#fff", e)
			}
		...
		_backgroundCircle: function() {
			...
			this.context.arc(d.backgroundCircle.roundX, d.backgroundCircle.roundY, d.radius, d.backgroundCircle.startAngle,
				d.backgroundCircle.endAngle);
		...
		_percentCircle: function(e) {
			...
			this.context.lineWidth = d.lineWidth;
			this.context.arc(d.backgroundCircle.roundX, d.backgroundCircle.roundY, d.radius, d.backgroundCircle.startAngle,
				d.backgroundCircle.startAngle + e / 100 * d.cMultiple, false);
